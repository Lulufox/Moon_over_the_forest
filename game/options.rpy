...
define config.name = _("Луна над лесом")
...
define config.version = "Демо"


## Текст, помещённый в экран "Об игре". Поместите текст между тройными скобками.
## Для отделения абзацев оставляйте между ними пустую строку.

define gui.about = _p("Привет, это Lulufox! \n\nСпасибо, что скачали данную игру.\n\nДемо-версия \"Луны над лесом\", в которую Вы сейчас играете, была сделана в рамках чэлленджа МикроРенО 2019.\nВы можете увидеть лог разработки игры {a=https://vk.com/topic-184204415_40242953/}{color=#B5CEE1}тут{/color}{/a}, а также ознакомиться с проектами, созданными другими участниками мероприятия, в {a=https://vk.com/microreno7/}{color=#B5CEE1}группе МикроРенО{/color}{/a}.\n\nПолная версия игры выйдет в конце 2019 года. Следить за процессом её создания можно в {a=https://vk.com/lulufoxx/}{color=#B5CEE1}моем паблике{/color}{/a}.\nКроме того, Вы можете оставить эл.адрес или ссылку на Вашу страницу в соц. сетях через {a=https://forms.yandex.ru/u/5d6568fdf198c00d392a833f/}{color=#B5CEE1}форму{/color}{/a}, тогда я лично пришлю Вам ссылку на скачивание полной версии игры, когда она будет готова.")
...
define build.name = "Moonovertheforest"
...
define config.main_menu_music = "улетай на крыльях ветра.mp3"
...
define config.save_directory = "Moonovertheforest-1564861370"
